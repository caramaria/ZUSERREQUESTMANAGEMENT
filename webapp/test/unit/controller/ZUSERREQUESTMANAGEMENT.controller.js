...
sap.ui.define([
	"ZUSERREQUESTMANAGEMENT/ZUSERREQUESTMANAGEMENT/controller/ZUSERREQUESTMANAGEMENT.controller"
	...
	QUnit.module("ZUSERREQUESTMANAGEMENT Controller");

	QUnit.test("I should test the app controller loads", function (assert) {
		var oAppController = new oController();
		var sName = oAppController.getMetadata().getName();
		assert.ok(sName, "ZUSERREQUESTMANAGEMENT/ZUSERREQUESTMANAGEMENT.controller.ZUSERREQUESTMANAGEMENT");
	});
