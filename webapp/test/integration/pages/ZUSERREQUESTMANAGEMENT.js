sap.ui.define([
	...
	"use strict";
	var sViewName = "ZUSERREQUESTMANAGEMENT";
			...
			assertions: {
				...
				iShouldSeeTheApp: function () {
					return this.waitFor({
						...
						viewName: sViewName,
						success: function () {
							Opa5.assert.ok(true, "The ZUSERREQUESTMANAGEMENT view is displayed");
						},
						errorMessage: "Did not find the ZUSERREQUESTMANAGEMENT view"
					});
				},
